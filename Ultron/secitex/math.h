  ...
  {
    if ((maximo == red) && (green >= blue)){
    	 return (60 * (green - blue)/(maximo - minimo) + 0);
    } 
    else if ((maximo == red) && (green <  blue)){
    	 return (60 * (green - blue)/(maximo - minimo) + 360);
    }
    else if (maximo == green){
    	return (60 * (blue - red)/(maximo - minimo) + 120);
    }
    else if (maximo == blue){
    	return (60 * (red - green)/(maximo - minimo) + 240);
    }
  }
